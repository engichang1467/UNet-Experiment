...
def eval(args, model, eval_loader, epoch, global_step, device, logger, writer, optimizer):
    ...
    model.eval()
    phys_channels = ['buoyancy', 'pressure', 'horizontal_velocity', 'vertical_velocity', 'vorticity']
...
def get_args():
    ...
    parser.add_argument("--nz", default=64, type=int, help="resolution of high res crop in y.")
...
def main():
    ...
    # setup model
    model = UNet3d(in_features=5, out_features=5,
